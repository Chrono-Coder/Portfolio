...
export default function Skills({ technologies }: Props) {
	return (
		<div className='relative  flex flex-col items-center  px-10 mx-auto text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-x-0'>
